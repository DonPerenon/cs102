...
class Calculator:
    def __init__(self, main):
        ...
        self.button_1 = ttk.Button(
            self.main, text="1", command=lambda: self.button_click(1)
        )
        self.button_2 = ttk.Button(
            self.main, text="2", command=lambda: self.button_click(2)
        )
        self.button_3 = ttk.Button(
            self.main, text="3", command=lambda: self.button_click(3)
        )
        self.button_4 = ttk.Button(
            self.main, text="4", command=lambda: self.button_click(4)
        )
        self.button_5 = ttk.Button(
            self.main, text="5", command=lambda: self.button_click(5)
        )
        self.button_6 = ttk.Button(
            self.main, text="6", command=lambda: self.button_click(6)
        )
        self.button_7 = ttk.Button(
            self.main, text="7", command=lambda: self.button_click(7)
        )
        self.button_8 = ttk.Button(
            self.main, text="8", command=lambda: self.button_click(8)
        )
        self.button_9 = ttk.Button(
            self.main, text="9", command=lambda: self.button_click(9)
        )
        self.button_0 = ttk.Button(
            self.main, text="0", command=lambda: self.button_click(0)
        )
        ...
        self.subtract_button = ttk.Button(
            self.main, text="-", command=self.button_subtraction
        )
        self.multiply_button = ttk.Button(
            self.main, text="*", command=self.button_multiply
        )
        self.divide_button = ttk.Button(self.main, text="/", command=self.button_divide)
        self.floor_div_button = ttk.Button(
            self.main, text="//", command=self.button_floor_div
        )
        self.modulus_button = ttk.Button(
            self.main, text="%", command=self.button_modulus
        )
